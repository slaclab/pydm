...
class PyDMSpinbox(QDoubleSpinBox, TextFormatter, PyDMWritableWidget):
    ...
    userMinimum = Property(bool, readUserMinimum, setUserMinimum)
    ...
    userMaximum = Property(bool, readUserMaximum, setUserMaximum)
    ...
    def setShowStepExponent(self, val):
        """
        Whether to show or not the step exponent
