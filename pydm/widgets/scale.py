...
class PyDMScaleIndicator(QFrame, TextFormatter, PyDMWidget):
    ...
    def readOrientation(self) -> Qt.Orientation:
        """
    ...
    def readBackgroundSizeRate(self) -> float:
        """
    ...
    backgroundSizeRate = Property(float, readBackgroundSizeRate, setBackgroundSizeRate)
    ...
    def setLimitsFromChannel(self) -> bool:
        """
    ...
    def readLimitsFromChannel(self, checked: bool) -> None:
        """
        Whether or not the scale indicator should use the limits information
        from the channel.
