...
class PyDMShellCommand(QPushButton, PyDMWidget):
    ...
    def readPyDMIconColor(self) -> bool:
        """
    ...
    def setPyDMIconColor(self, value: bool) -> None:
        """
        Whether or not to display a confirmation dialog.
    ...
    PyDMIconColor = Property(bool, readPyDMIconColor, setPyDMIconColor)
    ...
    command = Property("QStringList", readCommand, setCommand, designable=False)
    ...
    password = Property(str, readPassword, setPassword, designable=False)
