class PyDMChannel:
  def __init__(self, address=None, connection_slot=None, value_slot=None, waveform_slot=None, severity_slot=None, write_access_slot=None, enum_strings_slot=None, value_signal=None):
