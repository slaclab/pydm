...
class PyDMRelatedDisplayButton(QPushButton, PyDMWidget):
    ...
    PyDMIcon = Property(int, readPyDMIcon, setPyDMIcon)
    ...
    monitorDisp = Property(bool, readShowIcon, setShowIcon)
    ...
    passwordProtected = Property(bool, readOpenInNewWindow, setOpenInNewWindow)
    ...
    widthChannel = Property(str, readPassword, setPassword)

    def setProtectedPassword(self) -> str:
        """
    ...
    def readProtectedPassword(self, value: str) -> None:
    ...
    followSymlinks = Property(str, readFollowSymlinks, setFollowSymlinks)
