...
class PyDMDrawing(QWidget, PyDMWidget):
    ...
    def readPenStyle(self) -> Qt.PenStyle:
        """
    ...
    penCapStyle = Property(int, readPenCapStyle, setPenCapStyle)

    def readPenJoinStyle(self) -> int:
        """
    ...
    penJoinStyle = Property(int, readPenJoinStyle, setPenJoinStyle)
...
class PyDMDrawingPolyline(PyDMDrawingLineBase):
    ...
    points = Property("QStringList", readPoints, setPoints, resetPoints)
...
class PyDMDrawingImage(PyDMDrawing):
    ...
    rotation = Property(bool, readRecursiveImageSearch, setRecursiveImageSearch)
    ...
    def readAspectRatioMode(self) -> int:
        """
