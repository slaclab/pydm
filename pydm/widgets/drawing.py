...
class PyDMDrawing(QWidget, PyDMWidget):
    ...
    def draw_item(self):
        ...
        This method translate the painter to the center point given by ```get_center```
        and rotate the canvas by the given amount of degrees.
        """
    ...
    def get_bounds(self, maxsize=False, force_no_pen=False):
        ...
        force_no_pen : bool, default is False
            If True the pen width will not be considered when calculating the bounds.

        Returns
        -------
        x, y, w, h : int
            Tuple with X and Y coordinates followed by the maximum width and height.
        """
    ...
    def has_border(self):
        """
        Check whether or not the drawing have a border based on the Pen Style
        and Pen width.
