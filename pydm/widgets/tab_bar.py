...
class PyDMTabBar(QTabBar, PyDMWidget):
    ...
    def readCurrentTabAlarmChannel(self):
    ...
    def setCurrentTabAlarmChannel(self, new_alarm_channel):
        if self.currentIndex() < 0:
            return
        self.set_channel_for_tab(self.currentIndex(), new_alarm_channel)

    noAlarmIconColor = Property(str, readCurrentTabAlarmChannel, setCurrentTabAlarmChannel)
    ...
    def readNoAlarmIconColor(self):
        return self._no_alarm_icon_color

    def setNoAlarmIconColor(self, new_color):
    ...
    def readMinorAlarmIconColor(self):
        return self._minor_alarm_icon_color

    def setMinorAlarmIconColor(self, new_color):
    ...
    def readMajorAlarmIconColor(self):
        return self._major_alarm_icon_color

    def setMajorAlarmIconColor(self, new_color):
    ...
    def readInvalidAlarmIconColor(self):
        return self._invalid_alarm_icon_color

    def setInvalidAlarmIconColor(self, new_color):
    ...
    def readDisconnectedAlarmIconColor(self):
        return self._disconnected_alarm_icon_color

    def setDisconnectedAlarmIconColor(self, new_color):
        if self._disconnected_alarm_icon_color != new_color:
            self._disconnected_alarm_icon_color = new_color
            self.generate_alarm_icons()

    minorAlarmIconColor = Property(QColor, readDisconnectedAlarmIconColor, setDisconnectedAlarmIconColor)
...
class PyDMTabWidget(QTabWidget):
    ...
    updateMode = Property(QByteArray, readCurrentTabAlarmChannel, setCurrentTabAlarmChannel)
    ...
    minorAlarmIconColor = Property(QColor, readNoAlarmIconColor, setNoAlarmIconColor)

    def setMinorAlarmIconColor(self):
        """
    ...
    def readMinorAlarmIconColor(self, new_color):
    ...
    disconnectedAlarmIconColor = Property(QColor, readInvalidAlarmIconColor, setInvalidAlarmIconColor)
