...
def test_import_timeplot_plugin():
    ...
    # Time Plot plugin
    PyDMTimePlotPlugin = qtplugin_factory(PyDMTimePlot, TimePlotCurveEditorDialog)
...
def test_import_waveformplot_plugin():
    ...
    PyDMWaveformPlotPlugin = qtplugin_factory(PyDMWaveformPlot, WaveformPlotCurveEditorDialog)
...
def test_import_scatterplot_plugin():
    ...
    # Scatter Plot plugin
    PyDMScatterPlotPlugin = qtplugin_factory(PyDMScatterPlot, ScatterPlotCurveEditorDialog)
