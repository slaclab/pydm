...
Including the PyQtGraph source code into the PyDM project allows for rapid iteration on requests to enhance PyDM's 
plotting and image viewing capabilities. The base version of PyQtGraph embedded into this project is v0.12.2.
